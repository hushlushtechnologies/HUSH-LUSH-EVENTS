  ...
  return (
    ...
    >
      <div className="max-w-8xl mx-auto px-6 md:px-12 text-center">
        <h4
          // ref={headingRef}
          className="uppercase mb-4 tracking-[0.25em] text-sm md:text-base text-gray-300 font-poppins"
        >
          Introduction
        </h4>
        ...
        <h2
          // ref={subHeadingRef}
          className="text-2xl md:text-4xl mb-5 font-light leading-snug max-w-4xl mx-auto font-playfair"
        >
        ...
        <p className="mt-12 text-sm md:text-base text-gray-300 max-w-3xl mx-auto leading-relaxed font-poppins">
